                    ...
                    <div className="mt-16 relative">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                          <div className="border-2 border-red-900 bg-red-900/10 p-6 rounded-lg relative overflow-hidden z-10">
                            ...
                            <svg className="w-16 h-16 text-red-700 absolute -right-16 top-1/2 -translate-y-1/2 hidden lg:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                          </div>
                        ...
                        <div className="absolute h-32 w-full mt-8 hidden lg:block z-0" aria-hidden="true">
                          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1000 120" preserveAspectRatio="none">
                            <path d="M 900 60 C 900 110, 800 110, 500 110 C 200 110, 100 110, 100 60" stroke="#ef4444" strokeWidth="4" fill="none" strokeDasharray="10 10" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 text-left">
                        <div className="glass-card rounded-xl p-8 border-red-700 border-2 opacity-70">
                          ...
                          <ul className="mt-6 space-y-3">
                            <li className="flex items-center text-lg"><svg className="w-6 h-6 text-red-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"></path></svg>1 Ide, 1 Desainer</li>
                            <li className="flex items-center text-lg"><svg className="w-6 h-6 text-red-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"></path></svg>Sangat Lambat (1-2 Minggu)</li>
                            <li className="flex items-center text-lg"><svg className="w-6 h-6 text-red-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"></path></svg>Mahal & Berisiko (Berjudi)</li>
                          </ul>
                        </div>
                        ...
                        <div className="glass-card rounded-xl p-8 border-cyan-500 border-2 shadow-2xl shadow-cyan-500/30">
                          ...
                          <ul className="mt-6 space-y-3">
                            <li className="flex items-center text-lg"><svg className="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>500 Ide, 0 Desainer</li>
                            <li className="flex items-center text-lg"><svg className="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>Instan (5 Menit)</li>
                            <li className="flex items-center text-lg"><svg className="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>Bisa Diprediksi (Sistem)</li>
                          </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="md:w-1/2 w-full">
                          <div className="bg-slate-900 border border-slate-700 rounded-lg p-4 shadow-2xl shadow-slate-900/50">
                            ...
                            <div className="bg-slate-800 p-4 rounded-md">
                                <img src="https://i.ibb.co/L8y2wV1/mindmap-placeholder.png" alt="Mindmap UI" className="rounded"/>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="md:w-1/2 w-full">
                          <div className="bg-slate-900 border border-slate-700 rounded-lg p-4 shadow-2xl shadow-slate-900/50">
                            ...
                            <div className="bg-slate-800 p-4 rounded-md h-64 overflow-y-scroll">
                                <img src="https://i.ibb.co/2Z58xYQ/gallery-placeholder.png" alt="Gallery UI" className="rounded"/>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col md:flex-row items-center gap-12 mt-24">
                        ...
                        <div className="md:w-1/2 w-full">
                          <div className="bg-slate-900 border border-slate-700 rounded-lg p-4 shadow-2xl shadow-slate-900/50">
                            ...
                            <div className="bg-slate-800 p-4 rounded-md">
                                <img src="https://i.ibb.co/GvzQ3Jb/dashboard-placeholder.png" alt="Dashboard UI" className="rounded"/>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="glass-card p-8 rounded-xl border-red-700">
                        ...
                        <ul className="mt-6 space-y-4 text-lg text-slate-300">
                            <li className="flex"><svg className="w-6 h-6 text-red-500 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>Anda mencari "tombol ajaib" tanpa strategi.</li>
                            <li className="flex"><svg className="w-6 h-6 text-red-500 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>Anda menyalahkan "algoritma" alih-alih "iklan Anda".</li>
                        </ul>
                    </div>
                      ...
                      <div className="glass-card p-8 rounded-xl border-green-500 shadow-2xl shadow-green-500/20">
                        ...
                        <ul className="mt-6 space-y-4 text-lg text-slate-200">
                          <li className="flex"><svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>Anda <span className="font-bold">terobsesi</span> dengan ROAS dan profit.</li>
                          <li className="flex"><svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>Anda <span className="font-bold">benci bottleneck manual</span> (desainer, dll).</li>
                        </ul>
                      </div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20">
                        <div className="glass-card p-8 rounded-xl border-red-900 border-2 opacity-40 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-300">
                          ...
                          <p className="text-lg text-slate-300 mt-4">Tutup halaman ini. Kembali ke "Siklus Neraka". Kembali ke "feeling" Anda. Kembali membakar uang dan berharap "beruntung" bulan depan.</p>
                        </div>
                        ...
                        <div className="bg-white text-slate-900 p-8 rounded-xl shadow-2xl shadow-cyan-400/60 transform md:scale-110 border-4 border-cyan-300">
                          ...
                          <p className="text-lg text-slate-700 mt-4">Tekan tombol di bawah. Ambil kesempatan ini untuk membangun sistem Anda. Biarkan kami buktikan kami bisa mencetak "Winner" untuk Anda.</p>
                        </div>
                    </div>

                    <div className="mt-24 text-center">
                        <button onClick={onStart} className="cta-button font-black text-xl md:text-2xl uppercase py-5 px-12 rounded-lg shadow-2xl shadow-green-500/30 transition-all duration-300">
                          Mulai Bangun Pabrik Iklan Anda
                        </button>
                    </div>
                </div>
            </section>
